...
void ui_on_key(bool down, u32 key_code) {
    ...
    switch(key_code) {
        case SDLK_z: gamepad_get_state()->left_or_b = down<<1; gamepad_get_state()->select_buttons = 1<<4 ;break;
        case SDLK_x: gamepad_get_state()->right_or_a = down; gamepad_get_state()->select_buttons = 1<<4 ;break;
        case SDLK_RETURN: gamepad_get_state()->down_or_start = down<<3;gamepad_get_state()->select_buttons = 1<<4 ; break;
        case SDLK_TAB: gamepad_get_state()->up_or_select = down<<2;gamepad_get_state()->select_buttons = 1<<4 ; break;
        case SDLK_UP: gamepad_get_state()->up_or_select = down<<2;gamepad_get_state()->select_buttons = 1<<5 ; break;
        case SDLK_DOWN: gamepad_get_state()->down_or_start = down<<3;gamepad_get_state()->select_buttons = 1<<5 ; break;
        case SDLK_LEFT: gamepad_get_state()->left_or_b = down<<1;gamepad_get_state()->select_buttons = 1<<5 ; break;
        case SDLK_RIGHT: gamepad_get_state()->right_or_a = down;gamepad_get_state()->select_buttons = 1<<5 ; break;
    }
